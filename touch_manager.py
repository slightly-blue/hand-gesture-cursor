...
# keep injecting drag state while a condition is true 
...
class TouchManager:
  ...
  def __init__(self, x,y):
    ...
    if (windll.user32.InjectTouchInput(1, byref(touchInfo))==0):
        print("Injecting POINTER_FLAG_DOWN Failed with Error: "+ FormatError())
  ...
  def drag_update(self, x,y):
    ...
    if (windll.user32.InjectTouchInput(1,byref(touchInfo))==0):
        print("Injecting POINTER_FLAG_UPDATE Failed with Error: "+FormatError())
  ...
  def release_touch(self):
    ...
    if (windll.user32.InjectTouchInput(1,byref(touchInfo))==0):
        print("Injecting POINTER_FLAG_UP Failed with Error: "+FormatError())
